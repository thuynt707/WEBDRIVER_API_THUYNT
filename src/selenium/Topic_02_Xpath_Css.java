...
public class Topic_02_Xpath_Css {
	...
	public void TC_05_CreateAnAccount() throws InterruptedException {
		...
		String successMsg = driver.findElement(By
				.xpath(".//div[@class='dashboard']//span[text()='Thank you for registering with Main Website Store.']"))
				.getText();
		...
		// Verify system back to Home page
		Thread.sleep(5000);
